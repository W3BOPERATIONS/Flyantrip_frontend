    ...
    <>
      <div className="flex gap-6 mb-8">
        <motion.label 
          ...
          whileTap={{ scale: 0.95 }}
          className="flex items-center gap-2 text-sm font-bold cursor-pointer text-brand-black"
        >
        ...
        <motion.label 
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="flex items-center gap-2 text-sm font-bold cursor-pointer text-brand-black/60"
        >
      ...
      <div className="grid grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)_minmax(0,0.6fr)_auto] gap-4 items-end">
        <motion.div 
          ...
          className="relative flex items-center bg-white border border-black/10 rounded-2xl transition-all hover:shadow-lg hover:border-brand-red focus-within:border-brand-red focus-within:shadow-lg h-[100px] group/container"
        >
          {/* From Section */}
          <div 
                ...
                >
                  ...
                  <div className="max-h-80 overflow-y-auto pb-2">
                    {filteredAirports.map(a => (
                      <motion.div
                        key={a.iata}
                        whileHover={{ backgroundColor: 'rgba(206,49,49,0.05)' }}
                        className="mx-2 mb-0.5 p-3 flex items-center gap-3 cursor-pointer transition-all rounded-xl group"
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
            <motion.button 
              ...
              className="w-10 h-10 bg-white border border-black/5 rounded-full shadow-xl flex items-center justify-center text-brand-red transition-all hover:shadow-2xl group/swap"
            >
        ...
        <div className="relative">
          ...
          <motion.div
            whileHover={{ scale: 1.02 }}
            className="bg-white border border-black/10 p-4 rounded-xl font-semibold text-brand-black flex items-center justify-between gap-2 cursor-pointer transition-all hover:border-brand-red hover:shadow-lg focus-within:border-brand-red"
            onClick={() => {
            ...
            {showTravelersMenu && (
              ...
              >
                <div className="space-y-6">
                  ...
                  <motion.button
                    whileHover={{ scale: 1.02, backgroundColor: '#ce3131' }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full mt-2 bg-brand-black text-white py-3 rounded-xl text-sm font-bold transition-all hover:shadow-lg"
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="bg-brand-black text-white h-[58px] min-w-[160px] px-8 rounded-xl font-bold flex items-center justify-center gap-3 transition-all hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
