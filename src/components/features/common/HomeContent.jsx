  ...
  return (
    <>
      <motion.section 
        ...
        className="py-20 max-w-[1200px] mx-auto px-6"
      >
        ...
        <div className="grid grid-cols-5 gap-6">
          {[
            ...
            <motion.div 
              ...
              whileHover={{ y: -8 }}
              className="relative h-[400px] rounded-3xl overflow-hidden group cursor-pointer shadow-lg hover:shadow-2xl transition-all duration-500"
            >
        ...
        <div className="grid grid-cols-4 gap-6">
          {[
            ...
            <motion.div 
              ...
              transition={{ delay: i * 0.1, duration: 0.5 }}
              whileHover={{ y: -8 }}
              className="relative h-[300px] rounded-[32px] overflow-hidden group cursor-pointer shadow-md hover:shadow-xl transition-all duration-500 bg-white"
            >
          ...
          <div className="grid grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                ...
                className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-[32px] transition-all duration-500 group"
              >
      ...
      <motion.section 
        ...
        viewport={{ once: true }}
        transition={{ duration: 1 }}
        className="py-24 bg-[#FBFBFB] border-y border-black/5 overflow-hidden"
      >
          ...
          <div className="flex overflow-hidden">
            ...
            >
              {[
                ...
                <motion.div 
                  key={i} 
                  whileHover={{ scale: 1.05, borderColor: 'rgba(255,51,51,0.2)', backgroundColor: '#fff' }}
                  className="flex items-center gap-4 px-8 py-5 rounded-[24px] border border-black/5 bg-white shadow-sm transition-all cursor-crosshair group grayscale opacity-40 hover:grayscale-0 hover:opacity-100 min-w-[300px]"
                >
