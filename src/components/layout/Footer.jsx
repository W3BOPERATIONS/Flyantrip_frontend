    ...
    <div className="max-w-[1200px] mx-auto px-6">
      <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr] gap-x-12 gap-y-6 mb-6 border-b border-white/5 pb-6">
        <div className="flex flex-col gap-6 items-start">
          <Link to="/">
            <img src="/logos/logo.png" alt="FlyAnyTrip" className="h-10 w-auto object-contain max-w-[180px]" onError={(e) => { e.target.onerror = null; e.target.src = 'https://placehold.co/180x40/000000/ffffff?text=FlyAnyTrip'; }} />
          </Link>
